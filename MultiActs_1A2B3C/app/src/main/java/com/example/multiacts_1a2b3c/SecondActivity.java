    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        submitButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // 一定要輸入四個數字才有反應
                if (inputNumber.getText().length() == 4) { // getText() 方法返回的資料類型是 Editable，這是一個可變的字符序列對象
                    ...
                    historyResult.setText((game.checkRepeatedAnswer(inputNumber.getText().toString()) + "\n") + historyResult.getText());
                    // 清空輸入框
                    inputNumber.setText("");
                    // 如果猜中了
                    if (game.isWin()) {
